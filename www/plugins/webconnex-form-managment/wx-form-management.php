...
class wx_form_management {
  ...
  public static function wx_build_embed($formUrl, $content)
  {
    ...
    return '<div class="holds-wx-embed"><iframe class="wx-embed" src="'.$formUrl.'" width="100%" scrolling="no"></iframe></div> <p class="notice" style="font-size:0.8em">This window is secured by 256 bit encryption on a PCI compliant network. <a href="'.$directURL.'" target="_blank">Click here</a> to view this window in its own page.</p>';
  }
